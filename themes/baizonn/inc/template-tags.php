...
if ( ! function_exists( 'baizonn_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function baizonn_posted_on() {
...
if ( ! function_exists( 'baizonn_posted_by' ) ) :
	/**
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'baizonn' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'baizonn_post_thumbnail' ) ) :
	 ...
	 */
	function baizonn_post_thumbnail() {
